...
def run_tests():
    try:
        ...
        print(f"1 Произошла ошибка: {e}")
    try:
        test2()
        print("Тест 2 пройден!")
    except Exception as e:
        print(f"2 Произошла ошибка: {e}")
    try:
        test3()
        print("Тест 3 пройден!")
    except Exception as e:
        print(f"3 Произошла ошибка: {e}")
    try:
        test4()
        print("Тест 4 пройден!")
    except Exception as e:
        print(f"4 Произошла ошибка: {e}")
    try:
        test5()
        print("Тест 5 пройден!")
    except Exception as e:
        print(f"5 Произошла ошибка: {e}")
    try:
        test6()
        print("Тест 6 пройден!")
    except Exception as e:
        print(f"6 Произошла ошибка: {e}")
    try:
        test7()
        print("Тест 7 пройден!")
    except Exception as e:
        print(f"7 Произошла ошибка: {e}")
    try:
        test8()
        print("Тест 8 пройден!")
    except Exception as e:
        print(f"8 Произошла ошибка: {e}")
    try:
        test9()
        print("Тест 9 пройден!")
    except Exception as e:
        print(f"9 Произошла ошибка: {e}")
    try:
        test10()
        print("Тест 10 пройден!")
    except Exception as e:
        print(f"10 Произошла ошибка: {e}")
